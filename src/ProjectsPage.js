  ...
  render() {
    ...
    return (
      <Page page="projects" {...this.props}>
        <p>
          My latest project is this personal site, which is done in Vanilla React without any animation libraries.
          Try hovering over or touching the page headers / links on the home page!
        </p>
